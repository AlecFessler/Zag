// Spec §[timer_cancel] timer_cancel — test 01.
//
...
//
// Action
//   timer_cancel(invalid_handle). timer_cancel takes only the handle
//   id with the upper bits reserved; passing a clean (zero-extended)
//   u12 means the only error path that applies is BADCAP.
//
// Assertion
...
pub fn main(cap_table_base: u64) void {
    ...
    const result = syscall.timerCancel(empty_slot);

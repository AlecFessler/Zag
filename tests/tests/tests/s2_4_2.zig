...
/// §2.4.2 — device user view `field0` encodes: `device_type(u8, bits 0-7) | device_class(u8, bits 8-15) | irq_pending(bit 16) | reserved_zero(bits 17-31) | size_or_port_count(u32, bits 32-63)`.

...
/// §2.1.42 — Non-recursive kill of a non-restartable process with children makes it a zombie.
///
/// Plan:
...
///      "non-recursive kill" clause of §2.1.42 without going through a
///      fault-kill path.
///   5. Test root asserts:
...
pub fn main(pv: u64) void {
    ...
    const vm = syscall.mem_reserve(0, shm_size, vm_rw_s);

// Spec §[capabilities] delete — test 01.
//
...
//
// Action
//   delete(invalid_handle). delete takes only the handle id with the
//   upper bits reserved; passing a clean (zero-extended) u12 means
...
pub fn main(cap_table_base: u64) void {
    ...
    const result = syscall.delete(empty_slot);

/// VGA 8x16 bitmap font (CP437) — 256 glyphs, 16 bytes per glyph.
/// Each byte is one row of 8 pixels (MSB = leftmost pixel).
/// Source: Linux kernel lib/fonts/font_8x16.c (public domain).
pub const width = 8;
pub const height = 16;
...
pub const data: [256 * 16]u8 = .{
    ...
    0x00, 0x00, 0xc6, 0x00, 0x10, 0x38, 0x6c, 0xc6, 0xc6, 0xfe, 0xc6, 0xc6, 0x00, 0x00, 0x00, 0x00,

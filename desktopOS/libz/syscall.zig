...
/// Unmaps an SHM from a VM reservation. Teardown operation — errors are non-actionable.
...
/// Revokes a permission. Teardown operation — errors are non-actionable.
...
pub fn spawn_child(elf_ptr: u64, elf_len: u64, rights_bits: u64) SystemError!Handle {
    return proc_create(elf_ptr, elf_len, rights_bits);
}

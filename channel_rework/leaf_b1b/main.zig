...
pub fn main(perm_view_addr: u64) void {
    _ = perm_view_addr;
    syscall.write("leaf_b1b: starting, waiting for discovery entries\n");
    ...
    if (saw_proto1) syscall.write("leaf_b1b: FAIL saw proto=1\n");
    if (saw_proto2) syscall.write("leaf_b1b: FAIL saw proto=2\n");
    if (!saw_proto3) {
        syscall.write("leaf_b1b: FAIL did not see proto=3\n");
        return;
    }
    syscall.write("leaf_b1b: PASS visibility correct\n");
    while (true) {

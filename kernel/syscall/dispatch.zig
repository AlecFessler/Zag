...
pub fn dispatch(ctx: *ArchCpuContext) SyscallResult {
    ...
    return switch (syscall_num) {
        ...
        .mem_shm_unmap => .{ .ret = memory.sysMemShmUnmap(arg0, arg1) },
        .mem_mmio_map => .{ .ret = device.sysMemMmioMap(arg0, arg1, arg2) },
        .mem_mmio_unmap => .{ .ret = device.sysMemMmioUnmap(arg0, arg1) },
        ...
        .futex_wait => .{ .ret = futex.sysFutexWait(arg0, arg1, arg2) },
        ...
        .notify_wait => .{ .ret = system.sysNotifyWait(arg0) },

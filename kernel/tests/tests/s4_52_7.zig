...
/// §4.52.7 — `pmu_read` with `sample_ptr` not pointing to a writable region of `sizeof(PmuSample)` bytes returns `E_BADADDR`.
pub fn main(_: u64) void {
    ...
    t.expectEqual("§4.52.7", syscall.E_BADADDR, rc);

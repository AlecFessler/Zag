...
/// §2.2.5 — A parent cannot grant a child a `max_thread_priority` higher than its own.
///
...
pub fn main(_: u64) void {
    ...
    t.expectEqual("§2.2.5 child ceiling=NORMAL, create grandchild ceiling=HIGH", E_PERM, r);

...
/// §5.3.8 — `sys_info` requires no rights and is callable by any process.
///
...
/// to the parent via IPC. §5.3.8 says any process may call sys_info
...
pub fn main(_: u64) void {
    ...
    t.expectEqual("§5.3.8", syscall.E_OK, rc);
    syscall.shutdown();
}

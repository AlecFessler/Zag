...
/// §2.4.22 — `irq_ack` unmasks the IRQ line for the device associated with the given handle.
pub fn main(pv: u64) void {
    ...
    t.expectEqual("§2.4.22", syscall.E_BADHANDLE, rc);
    syscall.shutdown();
}

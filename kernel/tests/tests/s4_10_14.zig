...
/// §4.10.14 — `proc_create` with an invalid `max_thread_priority` value returns `E_INVAL`.
pub fn main(_: u64) void {
    ...
    t.expectEqual("§4.10.14 priority=7", E_INVAL, r1);
    ...
    t.expectEqual("§4.10.14 priority=0xFF", E_INVAL, r2);

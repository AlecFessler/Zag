...
/// §2.5.5 — Kernel-internal devices (HPET, LAPIC, I/O APIC) are not exposed in the user view.
...
pub fn main(pv: u64) void {
    ...
    _ = t.requireMmioDevice(view, "§2.5.5 baseline");
    ...
    for (0..128) |i| {
        ...
        if (zero_pci and !is_legacy_serial) {
            t.fail("§2.5.5 non_pci_non_serial");
            syscall.shutdown();
        }
    }

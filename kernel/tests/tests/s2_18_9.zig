...
/// §2.18.9 — `irq_ack` unmasks the IRQ line for the device associated with the given handle.
pub fn main(pv: u64) void {
    ...
    t.expectEqual("§2.18.9", syscall.E_BADHANDLE, rc);
    syscall.shutdown();
}
